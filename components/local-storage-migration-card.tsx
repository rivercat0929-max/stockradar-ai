...
import { getLocalStorageMigrationSummary, markMigrationSkipped, migrateLocalStorageToNeon } from "@/lib/migrations/local-storage-to-neon";
...
export function LocalStorageMigrationCard() {
  ...
  return (
    <section className="rounded-lg border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
      ...
      <p className="mt-1">持仓 {summary.holdingsCount} 条，自选股 {summary.watchlistCount} 条，预警 {summary.alertsCount} 条，设置：{summary.settingsFound ? "有" : "无"}。</p>
